...
const produtos = [
  ...
  {id: 8, nome: "Trono de Vidro - Torre do Alvorecer", preco: "79.90", imagem: "/imagem/tog.webp", descricao: "Volume Extra. Os leitores fiéis da série Trono de Vidro anseiam para saber como a narrativa de Chaol se desenrolaria, que caminho ele seguiria após tudo o que aconteceu. Torre do Alvorecer certamente nos dá isso e muito mais."},
  ...
  {id: 10, nome: "Box Trono de Vidro", preco: "389.90", imagem: "/imagem/togBox.jpg", descricao: "Box com 8 livros da saga Trono de Vidro. O Box Trono de Vidro traz, pela primeira vez, a série fenômeno mundial em um exuberante box rígido e livros com novo projeto gráfico."},
]
